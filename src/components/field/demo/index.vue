...
export default {
  i18n: {
    'zh-CN': {
      ...
      textCode: '短信验证码',
      button: '插入按钮',
      textAlignBottom: '内容下对齐',
      textAlignRight: '内容右对齐',
    },
    'en-US': {
      name: 'Field',
      basicUsage: 'Basic Usage',
      textarea: 'Textarea',
      customize: 'Customize Usage',
      ...
      errorPhone: 'Phone number format not correct',
      errorUsername: 'Please input user name',
      title: 'Title',
      ...
      password: 'Password',
      userName: 'User Name',
      textCode: 'SMS Verification Code',
      button: 'With Button',
